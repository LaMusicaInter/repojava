...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        students.add(new StudentClass("Даня", "ДД, ПДД, СОП(КС), СОП(Арт), СОП(ДС), НБ"));
        students.add(new StudentClass("Петя", "ДД, ПДД, СОП(КС), СОП(Арт), СОП(ДС)"));
        students.add(new StudentClass("Игорь", "ДД, ПДД, СОП(КС), СОП(Арт), СОП(ДС), НБ, ПДО"));
        students.add(new StudentClass("Маша", "ДД, ПДД, СОП(КС), СОП(ДС), НБ"));
        students.add(new StudentClass("Миша", "ДД, ПДД, СОП(КС), СОП(ДС)"));
        students.add(new StudentClass("Лиза", "ПДД, СОП(КС), СОП(ДС)"));
        students.add(new StudentClass("Алина", "ПДД, СОП(КС), СОП(ДС), КСП, ОСП, Кройка и Шитье"));
